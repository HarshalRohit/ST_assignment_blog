				...
				<div class="form-area">  
					...
					<br style="clear:both">
								...
								<div class="form-group">
									<input type="text" class="form-control" id="name" name="blog_title" placeholder="<?php echo $row['blog_title']; ?>">
								</div>
								<div class="form-group">
								<textarea class="form-control" type="textarea" id="message" name="blog_desc" placeholder="<?php echo $row['blog_desc']; ?>" rows="7"></textarea>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="subject" name="blog_category" placeholder="<?php echo $row['blog_category']; ?>">
								</div>
