		...
		<div class="col-md-12">
			<?php
				if($blogger_is_active == 0){
					...
					echo '
						<div class="form-area">  
							<form role="form" action="insert_in_blog.php" method="POST" id="form1" enctype="multipart/form-data">
								<br style="clear:both">
								...
								<div class="form-group">
								<textarea class="form-control" type="textarea" id="message" name="blog_desc" placeholder="Your Content" maxlength="140" rows="7"></textarea>
								</div>
								<div class="form-group">
